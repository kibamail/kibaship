...
your-control-plane-node:
  ip: "10.0.1.11"  # Internal IP for cluster communication
```
...
[kube_control_plane]
cp1 ansible_host=203.0.113.11 ip=10.0.1.11
cp2 ansible_host=203.0.113.12 ip=10.0.1.12
cp3 ansible_host=203.0.113.13 ip=10.0.1.13
```
